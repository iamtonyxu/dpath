...
module tb_thb2_filter_rtl;

    localparam DATA_W = 16;
    localparam COEFF_W = 16;
    localparam ACC_W = 40;
    localparam FRAC_W = 14;
    localparam MAX_TAPS = 7;
    ...
    task load_coeffs;
        begin
            coeff_ref[0] = -16'sd1344;
            coeff_ref[1] = 16'sd0;
            coeff_ref[2] = 16'sd9536;
            coeff_ref[3] = 16'sd16384;
            coeff_ref[4] = 16'sd9536;
            coeff_ref[5] = 16'sd0;
            coeff_ref[6] = -16'sd1344;
        end
    endtask
    ...
    initial begin
        ...
        push_sample(16'sd75, 16'sd50);
        wait_for_expected_outputs(exp_wr_ptr);
        $display("INFO: THB2 bypass case passed with %0d checks", checks);
        ...
        push_sample(16'sd0, 16'sd0);
        wait_for_expected_outputs(exp_wr_ptr);
        $display("INFO: THB2 impulse-response case passed with %0d checks", checks);
        ...
        wait_for_expected_outputs(exp_wr_ptr);
        $display("INFO: THB2 complex-stream case passed with %0d checks", checks);

        $display("INFO: all THB2 RTL tests passed");
        $finish;
    end
